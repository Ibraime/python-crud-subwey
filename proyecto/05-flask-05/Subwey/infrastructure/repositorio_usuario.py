...
from Subwey.infrastructure.errores import UsuarioDuplicadoError,UsuarioEnUsoError
...
class RepositorioUsuario:
    ...
    def eliminar(self, nombre):
        ...
        try:
            ...
            raise UsuarioEnUsoError(
                "No se puede eliminar el usuario porque tiene bocadillos asociados."
            )
