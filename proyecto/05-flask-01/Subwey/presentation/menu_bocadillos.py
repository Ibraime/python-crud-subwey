...
def main_bocadillos(servicio_ingrediente, servicio_bocadillo, servicio_usuario):
    """
    ...
    while True:
        ...
        try:
            ...
            if opcion == "1":
                ...
                autor_nombre = input("Elige el autor: ").strip() or "Anónimo"
                ...
                boc = servicio_bocadillo.crear_bocadillo(
                    nombre,
                    ingredientes,
                    descuento,
                    autor
