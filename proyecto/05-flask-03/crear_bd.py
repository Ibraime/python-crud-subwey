...
# Borra todo antes de crear para que sea un reseteo completo
cursor.execute("DROP TABLE IF EXISTS bocadillo_ingredientes")
cursor.execute("DROP TABLE IF EXISTS bocadillos")
